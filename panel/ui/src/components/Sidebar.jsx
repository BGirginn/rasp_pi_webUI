...
import { LayoutDashboard, Settings, Server, Wifi, Terminal, Activity, Monitor, LogOut, Folder, Cpu, Database, GitBranch, Ban, ListTodo, Store, Bell } from 'lucide-react';
...
export function Sidebar() {
  ...
  const menuItems = [
    ...
    { icon: ListTodo, label: 'Jobs', active: currentPage === 'jobs', page: 'jobs' },
  ...
  return (<motion.aside initial={{ x: -100, opacity: 0 }} animate={{ x: 0, opacity: 1 }} className={`relative md:sticky md:top-0 md:h-screen w-full md:w-64 ${isDarkMode ? 'bg-black/40' : 'bg-white/80'} backdrop-blur-xl border-r ${isDarkMode ? 'border-white/10' : 'border-gray-200'} p-4 md:p-6 z-20 flex flex-col shrink-0`}>

    {/* Scrollable Content Area */}
    <div className="flex-1 overflow-y-auto overflow-x-hidden -mx-4 px-4 scrollbar-none max-h-[55vh] md:max-h-none">
      {/* Logo */}
