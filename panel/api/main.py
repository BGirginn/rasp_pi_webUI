...
async def lifespan(app: FastAPI):
    ...
    try:
        ...
        logger.info("Action Registry loaded", actions_count=len(registry.get('actions', [])))
    except Exception as e:
        logger.error("FATAL: Action Registry failed to load", error=str(e))
        raise  # Refuse to start if registry is invalid
